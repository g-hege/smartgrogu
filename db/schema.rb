...
ActiveRecord::Schema[8.0].define(version: 2025_09_06_040638) do
  ...
  create_table "config", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", precision: nil, default: -> { "(now())::timestamp(0) without time zone" }
    t.datetime "updated_at", precision: nil, default: -> { "(now())::timestamp(0) without time zone" }
    t.text "shelly_kvs_device", default: ""
    t.text "kvs_key"
  end

  create_table "consumption", id: :serial, force: :cascade do |t|
    t.text "device", null: false
    t.datetime "timestamp", precision: nil, null: false
    t.decimal "value", default: "0.0", null: false
    t.decimal "reversed", default: "0.0"
    t.decimal "cost", default: "0.0"
  end

  create_table "crypto", id: :serial, force: :cascade do |t|
  ...
  create_table "daily_runtime", id: :serial, force: :cascade do |t|
    t.text "device", null: false
  ...
  create_table "device_runtime", id: :serial, force: :cascade do |t|
    t.text "device", null: false
    t.datetime "starttimestamp", precision: nil, null: false
    t.datetime "stoptimestamp", precision: nil, null: false
    t.integer "runtime", default: 0
  end

  create_table "energy", id: :serial, force: :cascade do |t|
    t.date "day", null: false
    t.decimal "grid_consumed", null: false
    t.decimal "solar_self_consumed", null: false
    t.decimal "solar_to_grid", null: false
    t.decimal "autarky_rate", null: false
    t.decimal "self_consumed_rate", null: false
    t.timestamptz "created_at", default: -> { "now()" }, null: false
    t.timestamptz "updated_at", default: -> { "now()" }, null: false
    t.decimal "real_wiener_netze"
    t.decimal "grid_price_netto", default: "0.0"
  end

  create_table "epex", id: :serial, force: :cascade do |t|
    t.datetime "timestamp", precision: nil, null: false
    t.decimal "marketprice", default: "0.0", null: false
  end
  ...
  create_table "recordings", id: :serial, force: :cascade do |t|
    ...
    t.datetime "timestamp", precision: nil, default: -> { "(now())::timestamp(0) without time zone" }, null: false
    t.boolean "es_export", default: false, null: false
  end
  ...
  create_table "solar_forecast", id: :serial, force: :cascade do |t|
    t.datetime "period_end", precision: nil, null: false
    t.decimal "pv_estimate", null: false
    t.decimal "pv_estimate10", null: false
    t.decimal "pv_estimate90", null: false
    t.datetime "created_at", precision: nil, default: -> { "(now())::timestamp(0) without time zone" }
    t.datetime "updated_at", precision: nil, default: -> { "(now())::timestamp(0) without time zone" }
  end

  create_table "spotty", id: :serial, force: :cascade do |t|
  ...
  create_table "twilight_data", id: :serial, force: :cascade do |t|
    ...
    t.time "nautical_twilight_begin"
    t.time "nautical_twilight_end"
    t.time "astronomical_twilight_begin"
    t.time "astronomical_twilight_end"
    t.timestamptz "created_at", default: -> { "now()" }, null: false
    t.timestamptz "updated_at", default: -> { "now()" }, null: false
  end
  ...
  create_table "weather", id: :serial, force: :cascade do |t|
    ...
    t.decimal "feels_like", null: false
    t.decimal "temp_min", null: false
    t.decimal "temp_max", null: false
    t.integer "pressure", null: false
    t.integer "humidity", null: false
    t.integer "visibility", null: false
    t.decimal "wind_speed", null: false
    t.integer "wind_deg", null: false
    t.integer "clouds", null: false
  end

  create_table "weather_forecast", id: :serial, force: :cascade do |t|
    t.datetime "timestamp", precision: nil, null: false
    t.text "main", null: false
    t.text "description", null: false
    t.text "icon", null: false
